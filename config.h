...
char font[] = "Hack-Regular:pixelsize=15:lcdfilter=lcddefault:rgba=rgb:antialias=true:autohint=false,Noto Color Emoji:antialias=true:autohint=true,Symbola:antialias=true:autohint=true";
